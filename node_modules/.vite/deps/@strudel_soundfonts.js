import {
  ...
  oe,
  q
} from "./chunk-RUDTLUZB.js";
import "./chunk-3H6SC4Y3.js";
import "./chunk-HDQR54EF.js";
import {
  Mi,
  __commonJS,
  __toESM,
      ...
      return function(e) {
        ...
        function(e, t, r) {
          ...
          var f = function(e2) {
            ...
            }(t2, n["RIFFChunk"]), r2 = t2, (f2 = [{ key: "getMetaData", value: function() {
        ...
        function(e, t, r) {
          ...
          var n = r(
            ...
            for (var u2 = [], l2 = 0; l2 < e2.length; l2++) {
              for (var f = e2[l2], d = e2[l2 + 1], p2 = f.bagIndex, h = d ? d.bagIndex : t2.length, y = [], v = void 0, g = p2; g < h; g++) {
                var E = a(g, t2, r2), m3 = c(g, t2, n2), b = m3[i.GeneratorType.KeyRange] && m3[i.GeneratorType.KeyRange].range, S = m3[s2];
                if (S) {
                  var T2 = o2[S.value];
                  T2 && y.push({ keyRange: b, modulators: E, generators: m3, reference: T2 });
                } else g - p2 == 0 && (v = { keyRange: b, modulators: E, generators: m3 });
              }
                ...
                if (o2) {
                  ...
                  if (i2) {
                    ...
                    if (s2) {
                      ...
                      if (c2) {
                        var l2 = c2.sample, f2 = a({}, s2.generators, c2.generators), d2 = a({}, s2.modulators, c2.modulators);
                        return { keyNumber: e4, preset: i2, instrument: u2, sample: l2, generators: f2, modulators: d2 };
                      }
                    }
                  }
                }
        ...
        function(e, t, r) {
          ...
          for (var o in l) ["GeneratorType", "DEFAULT_GENERATOR_VALUES", "ControllerType", "ControllerPolarity", "ControllerDirection", "ControllerPalette", "Controller", "TransformType", "DEFAULT_INSTRUMENT_MODULATORS", "default"].indexOf(o) < 0 && function(e2) {
            r.d(t, e2, function() {
              return l[e2];
            });
          }(o);
          ...
          for (var o in f) ["GeneratorType", "DEFAULT_GENERATOR_VALUES", "ControllerType", "ControllerPolarity", "ControllerDirection", "ControllerPalette", "Controller", "TransformType", "DEFAULT_INSTRUMENT_MODULATORS", "default"].indexOf(o) < 0 && function(e2) {
            r.d(t, e2, function() {
              return f[e2];
            });
          }(o);
...
var re2 = Object.fromEntries(
  Object.entries(import_soundfont2.DEFAULT_GENERATOR_VALUES).map(([e, t]) => [T[e], t])
);
var D = (e, t, n, o, r) => {
  var h, g, y, E, b, A, O;
  ...
  const a = t.generators[e], c = (g = (h = n.globalZone) == null ? void 0 : h.generators) == null ? void 0 : g[e], i = (y = o == null ? void 0 : o.generators) == null ? void 0 : y[e], l = (b = (E = r.globalZone) == null ? void 0 : E.generators) == null ? void 0 : b[e], d = a && "value" in a ? a.value : void 0, u = c && "value" in c ? c.value : void 0, f = i && "value" in i ? i.value : void 0, v = l && "value" in l ? l.value : void 0, p2 = (A = d != null ? d : u) != null ? A : s, M = (O = f != null ? f : v) != null ? O : 0;
  return p2 + M;
};
var J = (e) => import_soundfont2.DEFAULT_GENERATOR_VALUES[e] !== void 0;
var W = (e, t, n) => {
  var o, r, s, a;
...
function X(e, t, n) {
  ...
  const {
    ...
    pan: P = 0,
    ...Z
  } = n, B = 100 * (p2 !== void 0 && p2 !== -1 ? p2 : d) + u - M, I = r * 100 - B, K = 1 * Math.pow(2, I / 1200);
  ...
  const k = e.createGain(), H = [
    ...
    F >= 960 ? 0 : 1 - Q(F),
    m2(L)
  ], U2 = k.gain.dahdsr(...H), R = e.createStereoPanner();
...
var C = (e, t) => !e.keyRange || e.keyRange.lo <= t && t <= e.keyRange.hi;
var x = (e, t) => e.zones.filter((o) => C(o, t) && o.instrument).map((o) => o.instrument.zones.filter((r) => C(r, t)).map((r) => {
  const s = W(r, o, e);
  return {
    ...r,
    mergedGenerators: s
...
async function loadFont(name) {
  ...
  const load = async () => {
    const url = `https://felixroos.github.io/webaudiofontdata/sound/${name}.js`, preset = await fetch(url).then((e) => e.text());
    let [_, data] = preset.split("={");
    return eval("{" + data);
  };
  return loadCache[name] = load(), loadCache[name];
}
async function getFontBufferSource(e, s, l) {
  let { note: f = "c3", freq: a } = s, r;
  if (a)
    r = re(a);
  ...
  const { buffer: G2, zone: i } = await getFontPitch(e, r, l), n = l.createBufferSource();
  n.buffer = G2;
  const u = i.originalPitch - 100 * i.coarseTune - i.fineTune, o = 1 * Math.pow(2, (100 * r - u) / 1200);
  return n.playbackRate.value = o, i.loopStart > 1 && i.loopStart < i.loopEnd && (n.loop = true, n.loopStart = i.loopStart / i.sampleRate, n.loopEnd = i.loopEnd / i.sampleRate), n;
}
var bufferCache = {};
async function getFontPitch(e, s, l) {
  const f = `${e}:::${s}`;
  if (bufferCache[f])
...
async function getBuffer(e, s) {
  if (e.sample) {
    ...
    for (var l = 0; l < f.length / 2; l++)
      r = f.charCodeAt(l * 2), G2 = f.charCodeAt(l * 2 + 1), r < 0 && (r = 256 + r), G2 < 0 && (G2 = 256 + G2), i = G2 * 256 + r, i >= 65536 / 2 && (i = i - 65536), a[l] = i / 65536;
  } else if (e.file) {
    const f = e.file.length, a = new ArrayBuffer(f), r = new Uint8Array(a), G2 = atob(e.file);
    let i;
    for (let n = 0; n < G2.length; n++)
      i = G2.charCodeAt(n), r[n] = i;
    return new Promise((n) => s.decodeAudioData(a, n));
  }
}
    ...
    oe(
      ...
      async (l, f, a) => {
        const [r, G2, i, n] = q([
          ...
          f.sustain,
          f.release
        ]), { duration: u } = f, o = Mi(f.n, s.length), S = s[o], p2 = m(), t = await getFontBufferSource(S, f, p2);
        t.start(l);
        const U2 = p2.createGain(), C2 = t.connect(U2), d = l + u;
        U(C2.gain, r, G2, i, n, 0, 0.3, l, d, "linear");
        let m3 = d + n + 0.01, F = me(t.detune, f, l);
        Ge(t.detune, f, l, d), t.stop(m3);
        const R = (M) => {
        };
        return t.onended = () => {
          t.disconnect(), F == null ? void 0 : F.stop(), C2.disconnect(), a();
        }, { node: C2, stop: R };
      },
      { type: "soundfont", prebake: true, fonts: s }
    );
  });
}
var instruments = [
...
p.prototype.soundfont = function(e, s = 0) {
  return this.onTrigger((l, f, a) => {
    const r = m(), G2 = ji(f), i = e.presets[s % e.presets.length], n = r.currentTime + l - a, u = [r, i, st(G2), n];
    ce(...u)(n + f.duration);
  });
};
