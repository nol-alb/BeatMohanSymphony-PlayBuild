...
function S(t, i = {}) {
  var _a;
  const { wrapAsync: r = false, addReturn: u = true, emitMiniLocations: n = true, emitWidgets: y = true } = i;
  let g = parse3(t, {
    ecmaVersion: 2022,
    ...
    enter(e, o) {
      ...
      if (k(e))
        return y && c.push({
          ...
          // don't use value!
          min: ((_a2 = e.arguments[1]) == null ? void 0 : _a2.value) ?? 0,
          max: ((_b = e.arguments[2]) == null ? void 0 : _b.value) ?? 1,
          step: (_c = e.arguments[3]) == null ? void 0 : _c.value,
          type: "slider"
        }), this.replace(M(e));
      if (C(e)) {
  ...
  const { body: l } = g;
  if (!((_a = l == null ? void 0 : l[l.length - 1]) == null ? void 0 : _a.expression))
  ...
  let m = import_escodegen.default.generate(g);
  return r && (m = `(async ()=>{${m}})()`), n ? { output: m, miniLocations: p, widgets: c } : { output: m };
}
function d(t, i, r) {
  return t.type !== "Literal" ? false : t.raw[0] === '"';
}
function $(t, i) {
...
function C(t) {
  var _a;
  return t.type === "CallExpression" && x.includes((_a = t.callee.property) == null ? void 0 : _a.name);
}
function M(t) {
...
function A(t) {
  return `widget_${t.type}_${t.index}`;
}
function I(t, i) {
  const r = A(i);
  return t.arguments.unshift({
...
//# sourceMappingURL=chunk-2OTDA6XZ.js.map
