...
import { _mod as b, noteToMidi as H, register as h, isNote as G, logger as V, pure as B, silence as v, stack as R } from "@strudel/core";
...
function e1(m, P, M = 1) {
  m = m.map((t) => typeof t == "string" ? H(t) : t);
...
function d1({ chord: m, dictionary: P, offset: M = 0, n: e, mode: t = "below", anchor: n = "c5", octaves: d = 1 }) {
  ...
  let i, l, $ = a.map((u, D) => {
    const U = O[t](u), E = b(c - U - s, 12);
    return (i === void 0 || E < i) && (i = E, l = D), E;
  });
  t === "root" && (l = 0);
  const q = Math.ceil(M / a.length) * 12, T = b(l + M, a.length), F = a[T], K = O[t](F), Q = n - $[T] + q, z = F.map((u) => Q - K + u);
  let N = z.map((u) => t1(u));
...
const A1 = h("transpose", function(m, P) {
  ...
  return P.withHap((M) => {
    ...
    if (typeof M.value == "object")
      return M.withValue(() => ({
        ...M.value,
        note: _(M.context.scale, Number(m), M.value.note)
      }));
    if (typeof M.value != "string")
      throw new Error("can only use scaleTranspose with notes");
    return M.withValue(() => _(M.context.scale, Number(m), M.value));
  });
}), x1 = h(
  "scale",
  function(m, P) {
  ...
  "7b13sus": ["1P 5P 7m 11P 13m", "5P 7m 8P 11P 13m", "7m 11P 13m 14m 15P"]
}, { dictionaryVoicing: s1, minTopNoteDiff: c1 } = J.default || J, a1 = {
