// draw.js
// Strudel draw utilities
// Copyright (C) 2022 Strudel contributors
// See <https://github.com/tidalcycles/strudel/blob/main/packages/canvas/draw.mjs>
...
export const getDrawContext = (id = 'test-canvas', options) => {
  ...
  export class Drawer {
    ...
    invalidate(scheduler = this.scheduler, t) {
     ...
     // console.log("Visible points:", this.visibleHaps);
    }
    start(scheduler) {
      this.scheduler = scheduler;
      console.log('most recent:',scheduler);
      this.invalidate();
      this.framer.start();
    }
    stop() {
